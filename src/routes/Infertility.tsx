...
import { infertilityServices, doctors } from "@/lib/hospital-data";
  ...
  return (
    <SiteLayout>
      <PageHeader
        ...
        intro="A dedicated fertility unit led by Dr. Manisha Agrawal — from complete evaluation and in-house IUI to compassionate, personalised treatment plans for couples trying to conceive."
      >
        <div className="mt-8 flex flex-wrap gap-2">
          {infertilityServices.map((t) => (
            <a
              key={t.slug}
              href={`#${t.slug}`}
      ...
      <section className="mx-auto max-w-7xl space-y-6 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        {infertilityServices.map((topic) => (
            ...
            >
              <div className="grid gap-6 lg:grid-cols-3 lg:items-start">
                <div className="lg:col-span-1">
                  ...
                  <p className="mt-2 text-sm font-medium text-foreground/80">{topic.tagline}</p>
                </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <h2 className="mt-3 font-display text-3xl font-semibold text-foreground sm:text-4xl">
                  Get a clear fertility assessment before any treatment begins.
                </h2>
                <p className="mt-4 max-w-xl text-muted-foreground">
                  {doctors[1].name} brings {doctors[1].experience} of obstetrics and gynaecology
                  experience — book a consultation for an honest, personalised fertility plan.
                </p>
