...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trusted since 1995. Premium Orthopaedic, Trauma, Maternity & Infertility care in Kanpur, Uttar Pradesh. Book an appointment with expert doctors at Satya Hospital." },
      { name: "author", content: "Satya Hospital" },
      { name: "theme-color", content: "#1b3a8f" },
      { property: "og:title", content: "Satya Hospital — Trauma & Maternity Center" },
